...
from .encoder_noposplat import EncoderBioVisionCfg
...
class EncoderBioVisionMulti(Encoder[EncoderBioVisionCfg]):
    backbone: nn.Module
    gaussian_adapter: GaussianAdapter

    def __init__(self, cfg: EncoderBioVisionCfg) -> None:
        super().__init__(cfg)
